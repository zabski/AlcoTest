...
//    boolean isGrid = true;
    ...
    public AdmobNativeAds(Activity ctx){
        ...
        ADMOB_AD_UNIT_ID = ctx.getString(R.string.admob_native_id);
        //ADMOB_AD_UNIT_ID = "ca-app-pub-3940256099942544/2247696110";
        //ADMOB_AD_UNIT_ID = "ca-app-pub-3940256099942544/3986624511";
    }
    ...
    */
     ...
     */
    public void refreshAd(final FrameLayout frameLayout, boolean requestAppInstallAds, boolean requestContentAds, final boolean isGrid) {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                loadError = true;
                if (log>1) Toast.makeText(ctx, "Admob Failed to load native ad: " + errorCode, Toast.LENGTH_SHORT).show();
