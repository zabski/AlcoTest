...
public class PersonInfo {
	...
	private double BMR;
	private double nutriFactor; // factor to multiply RDI, based on BMR
	...
	// Record of drinks taken
	List<HashMap<String,Double>> mDrinks = new ArrayList<HashMap<String, Double>>();
	
	Map<String,Double> RDI; // Recommended Daily Intake (for food only)
   ...
   public static PersonInfo getInstance(Context ctx) {
	...
	// gets percentage of RDI (for food)
